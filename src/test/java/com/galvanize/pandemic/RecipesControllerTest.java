...
public class RecipesControllerTest {
    ...
    void getRecipeById() throws Exception {
        Recipe expected = new Recipe("sandwich", "you put the ingredients between the bread", "bread and stuff");
        ...
        mockMvc.perform(get("/recipes/1"))
                ...
                .andExpect(jsonPath("directions").value("you put the ingredients between the bread"))
                .andExpect(jsonPath("ingredients").value("bread and stuff"));
    }

    @Test
    void addRecipe() throws Exception {
        when(dataService.addRecipe(any(Recipe.class))).thenReturn(new Recipe("sandwich", "you put the ingredients between the bread", "bread and stuff"));

        mockMvc.perform(post("/recipes")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"name\":\"sandwich\", \"directions\":\"you put the ingredients between the bread\", \"ingredients\":\"bread and stuff\"}"))
                        .andExpect(status().isOk())
                        .andExpect(jsonPath("name").value("sandwich"))
                        .andExpect(jsonPath("directions").value("you put the ingredients between the bread"))
                        .andExpect(jsonPath("ingredients").value("bread and stuff"));
